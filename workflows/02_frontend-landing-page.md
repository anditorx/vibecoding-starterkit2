---
description: Create a modern, responsive, and feature-rich landing page for @anditorx GoClean using React, Vite, Tailwind CSS, and Shadcn UI, including assets and PWA setup.
---

# 02 Frontend Landing Page (@anditorx GoClean)
...
```tsx
<Helmet>
  <title>@anditorx GoClean | Jasa GoClean Premium Bogor</title>
